...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('status', sa.Enum('SUBMITTED', 'TRIAGED', 'IN_PROGRESS', 'RESOLVED', 'REJECTED', name='statusenum'), nullable=False),
        sa.Column('category', sa.Enum('WATER', 'ROADS', 'ELECTRICITY', 'WASTE', 'SANITATION', 'OTHER', name='categoryenum'), nullable=True),
